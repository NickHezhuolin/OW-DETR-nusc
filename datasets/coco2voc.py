...
def imagesets(coco_annotation_file, target_folder):
    ...
    with open("data/OWDETR/VOC2007/ImageSets/train_0923.txt", "a") as myfile:
...
if __name__ == '__main__':
    coco_annotation_file = '/home1/hezhuolin/0_data/coco2017/annotations/instances_train2017.json'

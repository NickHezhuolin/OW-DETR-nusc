...
python -u main_open_world.py \
    --pretrain '/home/hez4sgh/1_workspace/OW-DETR-nusc/exps/OWDETR_t1/checkpoint0024.pth' --batch_size 1 --output_dir ${EXP_DIR} --dataset owod_nusc --num_queries 100 --eval_every 5 --viz\
